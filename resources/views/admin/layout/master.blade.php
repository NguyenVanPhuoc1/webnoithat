        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="badge badge-danger navbar-badge" id="admin-notification">0</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-divider"></div>
                    <a href="{{url('admin/quanlinhantin')}}" class="dropdown-item" >
                        <i class="fas fa-envelope mr-2"></i> 0 Liên Hệ
                    </a>
                </div>
            </li>
            <li class="nav-item">
    ...
    <!-- Brand Logo -->
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 text-center">
                <div class="image">
                    <img class="lazy loaded"  data-src="{{ asset($logo) }}" alt="Nhóm 12"
                    src="{{ asset( $logo) }}" data-was-processed="true" style="width: 80px; height: 80px;">
                </div>
            </div>
            ...
            <nav class="mt-2">
                ...
                with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="{{ route('user_admin') }}" class="nav-link">
