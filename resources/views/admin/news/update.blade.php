...
@if(isset($news))
    <div class="content-wrapper edittintuc" id="edittintuc">
        <form action="{{route('admin-updateNews',['id' => $news['vi']->id ])}}" method="post" class="validation-form" id="updateNews" enctype="multipart/form-data">
        @csrf
        @method('patch')
                                        ...
                                        <div class="tab-content" id="custom-tabs-three-tabContent-slug">
                                            <div class="tab-pane fade show active" id="slug-tab" role="tabpanel" aria-labelledby="slug-tab">
                                                <div class="form-group">
                                                    ...
                                                    name="slug" id="slug" placeholder="Đường dẫn" value="{{ $news['vi']->slug }}" readonly>
                                                    @error('slug')
                                        ...
                                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang-vi" tabindex="0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm @error('news_name_vi') is-invalid @enderror" 
                                                    name="news_name_vi" id="news_name_vi" placeholder="Tên Tin Tức (vi)" value="{{ $news['vi']->news_name }}" >
                                                    @error('news_name_vi')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="contentvi" id="contentvi" cols="10" rows="80">{{ htmlspecialchars_decode($news['vi']->news_desc, ENT_QUOTES) }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="tabs-lang-en" role="tabpanel" aria-labelledby="tabs-lang-en" tabindex="0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm @error('news_name_en') is-invalid @enderror" 
                                                    name="news_name_en" id="news_name_en" placeholder="Tên Tin Tức (en)" value="{{ $news['en']->news_name }}">
                                                    @error('news_name_en')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="contenten" id="contenten" cols="10" rows="80">{{ htmlspecialchars_decode($news['en']->news_desc, ENT_QUOTES) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-primary card-outline text-sm">
                            ...
                            <div class="card-body text-center">
                                <div class="photoUpload-zone">
                                    @if(isset($news['vi']) && isset($news['vi']->news_image))
                                    <div class="photoUpload-detail mb-3 justify-content-center d-flex"  >
                                        <img class="rounded" src="{{ asset($news['vi']->news_image)}}"
