                                        ...
                                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                            ...
                                            <div class="tab-pane fade" id="tabs-lang-en" role="tabpanel" aria-labelledby="tabs-lang-en" tabindex="0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm @error('poli_name_en') is-invalid @enderror" name="poli_name_en" id="poli_name_en" placeholder="Tên Chính Sách (en)">
                                                    @error('poli_name_en')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
