...
@section('body')
<div class="content-wrapper addsanpham" id="addsanpham">
    <form action="{{ route('add-product') }}" method="post" class="validation-form" id="addProduct" enctype="multipart/form-data">
    @csrf
                                        ...
                                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang-vi" tabindex="0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm @error('product_name_vi') is-invalid @enderror" name="product_name_vi" id="product_name_vi" placeholder="Tên Sản Phẩm (vi)" >
                                            ...
                                            <div class="tab-pane fade" id="tabs-lang-en" role="tabpanel" aria-labelledby="tabs-lang-en" tabindex="0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm @error('product_name_en') is-invalid @enderror" name="product_name_en" id="product_name_en" placeholder="Tên Sản Phẩm (en)">
