                ...
                <div class=" col-md-12 ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-inline form-search d-inline-block align-middle col-lg-3 w-100  mt-2 mb-2">
                            <form action="{{route('news_admin')}}" method="GET" id="news_search" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="" title="Bàn ăn">
                                                <img class="rounded img-preview" src="{{ asset($item ->news_image)}}" alt="{{$item ->news_image}}" style="max-width: 70px; max-height: 55px;">                                        </a>
                                        </td>
                                        <td class="align-middle text-center">
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            <a class="text-primary mr-2" href="{{route('view_update_news',['id' => $item->id ])}}"
...
<script src="{{ asset('admin/dist/js/quanlitintuc.js')}}"></script>
<script>
    function updateNoiBat(newsId) {
    var isChecked = $('#show-checkbox-noibat-' + newsId).prop('checked');
    // console.log(isChecked);
    $.ajax({
        url: '/admin/quanlibaiviet/tintuc/update-noibat/' + newsId ,
        type: 'post',
        data: {
            _token: '{!! csrf_token() !!}',
            noi_bat: isChecked
