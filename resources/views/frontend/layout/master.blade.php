            ...
            <li>
                ...
                <ul>
                    ...
                    @if(Auth::check() )
                        ...
                        <li><a class="view_cart" href="{{ url('/gio-hang') }}">{{trans('frontend.cart')}}</a></li>
            ...
            <div class="wrap-content d-flex align-items-center">
                <div class="wrap-logo">
                    <a class="logo-header" href="{{ url('/') }}">
                        <img class="lazy loaded" src="{{ $logo }}"
                            data-was-processed="true" style="width: 100px; height: 100px;">
                    </a>
                </div>
                <div class="wrap-header-menu">
                    <div class="header d-flex justify-content-between align-items-center"
                        ...
                        <div class="hotline_account d-flex">
                            <!-- hotline -->
                            <p class="info-header mx-3">Hotline: <span>0707 958 117</span></p>
                            <!-- Account -->
                            <div class="dropdown account_user  mx-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        <a class="dropdown-item view_cart" href="{{ url('/gio-hang') }}">{{trans('frontend.cart')}}</a>
                        ...
                        <div class="box-info__header d-flex align-items-center">
                            ...
                            <div class="lang-header d-flex">
                                <a href="{{ route('change-language', ['locale' => 'vi']) }}" class="transition">
                                    <img src="{{ asset('front/public/image/ic-vi.png') }}" alt="vi">
                                </a>
                                <a href="{{ route('change-language', ['locale' => 'en']) }}" class="transition">
            ...
            <div class="menu-bar-res">
                ...
                <div class="box-flex flex-center align-items-center">
                    ...
                    <div class="lang-header">
                        <a class="transition" href="{{ route('change-language', ['locale' => 'vi']) }}"><img src="{{ asset('front/public/image/ic-vi.png') }}"
                                alt="vi"></a>
                        <a class="transition" href="{{ route('change-language', ['locale' => 'en']) }}"><img src="{{ asset('front/public/image/ic-en.png') }}"
                                alt="en"></a>
                    </div>
                    @if(Auth::check())
